...
class Net(nn.Module):
  ...
  def forward(self, x):
    x = nn.functional.max_pool2d(nn.functional.relu(self.conv1(x)), (5, 5))
    x = nn.functional.max_pool2d(nn.functional.relu(self.conv2(x)), (5, 5))
    x = nn.functional.max_pool2d(nn.functional.relu(self.conv3(x)), (5, 5))
